...
ALLOWED_HOSTS = []#'localhost', '127.0.0.1']  # Agrega aquí los hosts permitidos en producción
...
LANGUAGE_CODE = 'es-co'  # Cambia el código de idioma a español para Colombia

TIME_ZONE = 'America/Bogota'  # Cambia la zona horaria a la de Colombia
